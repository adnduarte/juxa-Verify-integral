...
import { FileText, Upload, Play, CheckCircle2, AlertCircle, Search, Clock, Briefcase, Building2, RefreshCw, Bot } from 'lucide-react';
      ...
      >
        {activeTab === 'workspace' && (
          <div className="grid lg:grid-cols-3 gap-6 h-full">
            ...
            <div className="lg:col-span-1 space-y-4">
              <h2 className="text-lg font-bold text-slate-900">Mis Reportes en Progreso</h2>
              
              <div className="bg-white p-4 rounded-2xl border-2 border-blue-600 shadow-sm cursor-pointer">
                <div className="flex justify-between items-start mb-2">
                  <span className="text-xs font-bold text-blue-600 uppercase tracking-wider">ORD-2026-089</span>
                  <span className="w-2 h-2 rounded-full bg-blue-600"></span>
                </div>
                <h3 className="font-bold text-slate-900">Estudio Socioeconómico</h3>
                <p className="text-sm text-slate-500 mb-3">Candidato: Juan Pérez</p>
                <div className="flex items-center text-xs text-slate-400">
                  <Clock className="w-3 h-3 mr-1" /> Vence en 2 días
                </div>
              </div>

              <div className="bg-white p-4 rounded-2xl border border-slate-200 shadow-sm cursor-pointer hover:border-blue-300 transition-colors">
                <div className="flex justify-between items-start mb-2">
                  <span className="text-xs font-bold text-slate-500 uppercase tracking-wider">ORD-2026-090</span>
                </div>
                <h3 className="font-bold text-slate-900">Verificación de Crédito</h3>
                <p className="text-sm text-slate-500 mb-3">Empresa: Tech Solutions SA</p>
                <div className="flex items-center text-xs text-slate-400">
            ...
            <div className="lg:col-span-2">
              <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden h-full">
                <div className="px-6 py-4 border-b border-slate-200 bg-slate-50 flex justify-between items-center">
                  <div>
                    <h2 className="text-lg font-bold text-slate-900">Espacio de Trabajo: ORD-2026-089</h2>
                    <p className="text-sm text-slate-500">Carga de Evidencia y Análisis IA</p>
                  </div>
                </div>
                ...
                <div className="p-6">
                  ...
                  <div className="border-2 border-dashed border-slate-300 rounded-xl p-8 text-center mb-6 hover:bg-slate-50 transition-colors">
                    ...
                    <h3 className="text-sm font-medium text-slate-900 mb-1">Arrastra documentos o imágenes aquí</h3>
        ...
        {activeTab === 'reports' && (
          <div>
            ...
            <p className="text-slate-600">Historial de reportes generados y en proceso.</p>
          </div>
        )}

        {activeTab === 'history' && (
          <div>
            <h2 className="text-xl font-bold text-slate-900 mb-4">Historial de Actividad</h2>
            <p className="text-slate-600">Registro de todas las acciones realizadas en la plataforma.</p>
          </div>
        )}
