...
import { Users, FileText, CheckCircle2, AlertCircle, Briefcase, Plus, Bot, Search, Eye, Brain, Clock } from 'lucide-react';
    ...
    >
          ...
          {loading ? (
            ...
            <div className="grid grid-cols-1 gap-4">
              {filteredInvestigations.map((inv) => (
                <div key={inv.id} className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm hover:shadow-md transition-all">
      ...
      {activeTab === 'rules' && (
        <div>
          ...
          <p className="text-slate-600">Configura los parámetros de validación para tus candidatos (ej. antecedentes, referencias).</p>
        </div>
      )}
