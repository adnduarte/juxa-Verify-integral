  ...
  return (
    <div className="flex flex-col items-center justify-center p-8 space-y-6">
      <div className="relative">
        ...
        />
        <div className="relative flex items-center justify-center w-24 h-24 bg-white rounded-2xl shadow-xl border border-blue-100">
          <motion.div
            animate={{ rotate: 360 }}
      ...
      {typeof progress === 'number' && (
        <div className="w-full max-w-xs space-y-2">
          ...
          <p className="text-xs font-bold text-slate-400 text-right">{progress}%</p>
        </div>
      )}
    </div>
  );
